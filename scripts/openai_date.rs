...
Rules:
- You must parse the input into a date/time if possible
- Any input not resulting in a date/time string, must be ignored and answered with the failure "Unknown"
- Only answer with a complete date/time string, or the failure "Unknown"
- Do not provide any additional information nor error context
